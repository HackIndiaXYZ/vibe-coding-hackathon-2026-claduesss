  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      ...
      {!loading && posts.length === 0 && (
        ...
        >
          <span className="text-6xl mb-4" role="img" aria-label="camera">📸</span>
          <h2 className="text-xl font-bold mb-2" style={{ color: '#1F2937' }}>No posts yet</h2>
          <p className="text-sm" style={{ color: '#6B7280' }}>Be the first to share a smile!</p>
        </motion.div>
      )}
